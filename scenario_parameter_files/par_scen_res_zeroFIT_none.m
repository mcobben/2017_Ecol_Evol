...
switchL=3;              % location: 1=compl, 2=migrants, 3=residents
switchG=1;              % genetic diversity: 1=zero, 2=full 
Tfit=0.1;               % fitting T-value: migr=0.9, res=0.1
delta_surv=0.2;            % change in survival: 0.2=increase, -0.2=decrease

%% check xlsx file scenario_schedule
year_tot=1000;           % total number of generations: 300 600 1000 10000
year_change=year_tot;           % the year of changing survival conditions: 1 301 year_max
yrs_output=[1 20 40 60 80 100 120 140 160 180 200 220 240 260 280 300 400 500 600 700 800 900 1000];
