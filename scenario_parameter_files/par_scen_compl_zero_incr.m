...
switchL=1;              % location: 1=compl, 2=migrants, 3=residents
...
year_tot=300;           % total number of generations: 300 600 1000 10000
year_change=1;           % the year of changing survival conditions: 1 301 year_max
yrs_output=[1 20 40 60 80 100 120 140 160 180 200 220 240 260 280 300];
